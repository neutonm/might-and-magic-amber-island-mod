...
function events.LoadMap()
    ...
    for _, mon in Map.Monsters do
        if mon.NPC_ID  == 516 then
            if vars.QuestsAmberIsland.QVarRansomTaken == true then
                RemoveMonster(mon)
            end
        elseif mon.NPC_ID  == 518 then
            mon.Hostile = false -- Buster Squeaky
...
for i = 0, 9, 1 do
    evt.hint[100 + i]        = ModTxt.CGoldVein  -- "Ore Vein"
...
-- Main Door Entrance
evt.hint[110]       = ModTxt.CLeaveDungeon
