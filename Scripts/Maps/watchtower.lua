...
-- Rest Rooms
evt.hint[32]        = ModTxt.CSafeRoom
evt.map[32]         = function()
    evt.EnterHouse(581)
end

-- Wine Racks
evt.hint[33]        = ModTxt.CWineRack
evt.map[33]         = function()

end

evt.hint[34]        = ModTxt.CWineRack
evt.map[34]         = function()

end

evt.hint[35]        = ModTxt.CWineRack
evt.map[35]         = function()

end

evt.hint[36]        = ModTxt.CWineRack
evt.map[36]         = function()

end

evt.hint[37]        = ModTxt.CWineRack
evt.map[37]         = function()

end

evt.hint[38]        = ModTxt.CWineRack
evt.map[38]         = function()

end

-- Secret: Dwarven Hideout > Bookcase
evt.hint[39]        = ModTxt.CBookcase
evt.map[39]         = function()
...
-- Exit
evt.hint[41]        = ModTxt.CLeaveDungeon
evt.map[41]         = function()
    evt.MoveToMap{
        X           = 15375,
        Y           = -11428,
